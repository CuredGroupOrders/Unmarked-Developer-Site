...
export const services = [
  {
    ...
    description:
      "Native and cross-platform experiences built for speed, reliability, and long-term maintainability.",
    bullets: ["iOS and Android delivery", "Product design to app store launch", "Performance and analytics instrumentation"],
  },
  {
    title: "Custom Software Solutions",
    description:
      "Business software designed around your workflow, integrations, and growth trajectory.",
    bullets: ["Internal tools and operations platforms", "API and systems integration", "Scalable cloud architecture"],
  },
  {
    title: "AI-Enabled Product Engineering",
    description:
      "Practical AI capabilities integrated into real products to improve productivity and decision quality.",
    bullets: ["AI feature strategy and prototyping", "LLM-enabled workflows and copilots", "Safety, quality, and governance controls"],
  },
];

export const trustPoints = [
  "Delivery process built around transparency and weekly progress checkpoints.",
  "Security-minded engineering standards from architecture through release.",
  "Partnership model focused on outcomes, not just deliverables.",
];
